...
class WaveFormTrace(object):
    ...
    def __init__(self, background_clr='black', x_width=20, y_width=10):
...
#            col = p.get_facecolor()[-1, :3]
    ...
    def generate_traces_spatial_location(self, traces, vis_chans=[0], scale = 1.0, color='black',linewidth=1, alpha=0.1):
        """Plot spatial trace of the units
