...
from yass.templates.util import (align_templates, merge_templates,
                                 ...
                                 get_templates_parallel_firstbatch)
...
def run(standardized_recording, spike_train, tmp_loc, 
    ...
    templates, weights = get_templates_parallel_firstbatch(
                                standardized_recording,spike_train,
                                path_to_recordings, output_directory, CONFIG)
    ...
    path_templates = os.path.join(
                                ...
                                output_directory,
                                'templates_unclean.npy')

    np.save(path_templates, templates)
    ...
    # merge templates
    templates, spike_train_clear_after_templates, groups = merge_templates(
    ...
    return templates, spike_train_clear_after_templates, 
