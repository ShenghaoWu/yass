...
def butterworth(path_to_data,
    ...
    (path, params) = bp.multi_channel_apply(
        _butterworth,
        mode='disk',
...
def filter_standardize_stream(idx_list, low_frequency, high_factor, order,
                       sampling_frequency, buffer_size, filename_dat,
                       n_channels, root_folder, output_directory):
    """ Same as filter_standardize but doesn't save to disk 
    """
